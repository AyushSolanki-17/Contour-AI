...
| `P0-13B` | 2026-08-31 | Provider-neutral principals, uniform memberships, verified access contexts, and non-enumerating tenant-scoped service access. | [PR #13](https://github.com/AyushSolanki-17/Contour-AI/pull/13) |
| `P0-13` | 2026-09-06 | Authenticated, tenant-scoped Tenant, Workspace, and Source collection routes with stable idempotency, cursor, error, and OpenAPI behavior. | [PR #14](https://github.com/AyushSolanki-17/Contour-AI/pull/14), [PR #22](https://github.com/AyushSolanki-17/Contour-AI/pull/22) |
| `P0-12` | 2026-09-06 | Deterministic PEP-fixture normalization with source-neutral manifest artifacts, exact raw-byte locators, and derived-artifact integrity enforcement. | [PR #23](https://github.com/AyushSolanki-17/Contour-AI/pull/23), [PR #24](https://github.com/AyushSolanki-17/Contour-AI/pull/24) |
